                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        flex: 9,
                        child: categories.isEmpty || makes.isEmpty
                            ? Container(
                                child: Center(
                                  child: Text("Loading.."),
                                ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(products[index]
                                                                              ...
                                                                              'name']),
                                                                          role == 0
                                                                              ? Text("       " + products[index]['retail price'].toString() + " \$")
                                                                              : Text(products[index]['wholesale price'].toString()),
                                                                        ],
                                                                      ),
                                                                    ),
                                                                    Expanded(
                                                                      ...
                                                                      FirebaseFirestore
                                                                        ...
                                                                        ..collection("users")
                                                                          ...
                                                                          'name':
                                                                              products[index]['name'],
                                                                          'nameK':
                                                                              products[index]['nameK'],
                                                                          'nameA':
                                                                              products[index]['nameA'],
                                                                          'price': role == 0
                                                                              ? products[index]['retail price']
                                                                          ...
                                                                          'quantity':
                                                                              quantity,
                                                                          'subPrice': role == 0
                                                                              ? products[index]['retail price'] * quantity
                                                                              : products[index]['wholesale price'] * quantity,
                                                                        }).whenComplete(() {
                                                                          Navigator.pop(
                                                                              context,
                                                                              'Cancel');
